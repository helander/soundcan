...
//  suil_init(argc, argv, SUIL_ARG_NONE);
#endif
	printf("\nA#################################kr##kr#kr#kr#kr#kr#kr##########");fflush(stdout);
  // Parse command-line arguments
  JalvFrontendArgs args = {argc, argv};
  const int        ret  = jalv_frontend_init(&args, &jalv->opts);
	printf("\nB#################################kr##kr#kr#kr#kr#kr#kr##########");fflush(stdout);
  if (ret) {
	printf("\nC#################################kr##kr#kr#kr#kr#kr#kr##########");fflush(stdout);
    return ret;
  }
	printf("\nD#################################kr##kr#kr#kr#kr#kr#kr##########");fflush(stdout);
  ...
  // Apply loaded state to plugin instance if necessary
	printf("\nApply state before#################################kr##kr#kr#kr#kr#kr#kr##########");fflush(stdout);
  if (state) {
	printf("\nApply state inside 1#################################kr##kr#kr#kr#kr#kr#kr##########");fflush(stdout);
    jalv_apply_state(jalv, state);
	printf("\nApply state inside 2#################################kr##kr#kr#kr#kr#kr#kr##########");fflush(stdout);
    lilv_state_free(state);
	printf("\nApply state inside 3#################################kr##kr#kr#kr#kr#kr#kr##########");fflush(stdout);
  }
	printf("\nApply state after#################################kr##kr#kr#kr#kr#kr#kr##########");fflush(stdout);
